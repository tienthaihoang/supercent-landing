...
export default function Navbar() {
  ...
  return (
    <>
      {eventEnded && (
        <div className="fixed top-0 left-0 w-full z-[100] bg-gradient-to-r from-purple-700 to-blue-700 text-white text-center py-2 text-sm md:text-base font-semibold shadow-md">
          🎉 {t("ended")}.
        </div>
      )}
      ...
      <nav
        className={`fixed ${
          eventEnded ? "top-14" : "top-4"
        } left-1/2 -translate-x-1/2 z-[99] w-[95%] max-w-7xl bg-[#1C1B1A]/50 backdrop-blur-[4px] shadow-[0_0_36px_rgba(0,109,184,0.25)] border border-white/10 rounded-2xl md:rounded-full transition-all duration-300`}
      >
